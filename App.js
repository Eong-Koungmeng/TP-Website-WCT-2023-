...
function App() {
  ...
  /*Handle for Getting selectedTicket ID*/
  const handleGetTicketId = (id) => {
  ...
  useEffect(() => {
    if (selectedTicketId) {
      const selectedData = ticketData.find((ticket) => ticket.id === selectedTicketId);
      ...
      <Container className="container">
          <Routes>
              <Route index element={<Home 
                ...
                handleGetTicketId={handleGetTicketId}
                />}
              />
              ...
              <Route  path="/Save" element={<Save 
                ...
                handleCheckTicket={handleCheckTicket}/>} 
              />
              <Route  path="/TicketPage/:ticketId" element={<TicketPage selectedTicketData={selectedTicketData}/>} /> 
